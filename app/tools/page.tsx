...
export default function ToolsPage() {
  ...
  const [ratio, setRatio] = useState(21); // 默认对比度
             ...
             <div className="max-w-3xl space-y-6">
                ...
                {output && (
                  <div className="bg-[#1a1a1a] border border-primary/30 rounded-2xl p-6 relative group animate-fade-in">
                     ...
                     <button onClick={copyToClipboard} className="absolute top-4 right-4 text-xs text-primary hover:text-white transition-colors">Copy</button>
                  </div>
                )}
             </div>
          </div>
